...
# update the raw superpixel map, where the input maps contains the pobability of each pixel belong to any of the superpixel, and the output map contains the superpixel index that each pixel belong to.
def update_spixl_map (spixl_map_idx_in, assig_map_in):
    ...
    # get the superpixel idx with highest probability of each pixel in the images. In other word, get the closest neighborhood pixel for each pixel.
