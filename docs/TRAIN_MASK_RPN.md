...
The repository currently provides the Mask RPN training reader and the released
trained checkpoint. If you want to retrain this model from scratch, first run or
reimplement the same superpixel + evolutionary search procedure to create the
score-record JSON files described below. Do not replace these records with
ordinary object-detection annotations unless you intentionally want to train a
different proposal model.
